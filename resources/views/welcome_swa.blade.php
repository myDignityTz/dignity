    ...
    <div class="relative">
        ...
        <div class="absolute top-0 bottom-0 right-0 w-1/2 bg-white mt-16 mb-16 mr-12 rounded-lg shadow-lg opacity-75">
            <div class="px-16 py-16">
                <h2 class="text-4xl font-bold tracking-wider mb-4">Utu Wangu</h2>
    ...
    <section class="bg-white pt-24 pb-24">
        <div class="w-2/3 mx-auto">
            ...
            <div class="text-lg text-gray-700 leading-loose">
                <p class="mb-4">
                    Kazi yetu imejikita haswa kwenye kurahisisha mawasiliano baina ya mabinti na wazazi
                    linapokuja suala la mazungumzo juu ya elimu ya afya ya uzazi, kwa kuwapa
                    mbinu wazazi ambazo zitafanya zitasaidia kuongelea suala hili kwa urahisi.
                </p>

                <p class="mb-4">
                    Si kweli kwamba siku zote wazazi huwa na habari za kina juu ya afya ya uzazi, na hivyo ni
                    muhimu kwa mzazi kuwa na habari za kina kabla ya kuongea na watoto wao kwani inawaongezea
                    ujasiri na ushujaa ambao wanauhitaji kuongea na vijana wao, kwa hivyo kwenye wavuti yetu
                    tutatoa elimu ya afya ya uzazi kwa wazazi ili kuongeza ujuzi wao katika afya ya uzazi.
                </p>
                ...
                <div>
                    <div class="flex mb-12">
                        ...
                        <div class="w-4/5 text-2xl leading-loose">
                            Itawapa wazazi habari za kina juu ya afya ya uzazi, haswa mada ambazo tumepata
                            za kufurahisha zaidi na kusaidia vijana vijana, kuwapa ujasiri zaidi na ujasiri
                            wa kuzungumza.
                        </div>
                    </div>
                    ...
                    <div class="flex mb-12">
                        ...
                        <div class="w-4/5 text-2xl leading-loose">
                            Utatuwezesha kuunda mfumo wa ujumbe kwa wasichana wanaopeana SRH moja kwa moja
                            kwa kutumia mbinu zilizoundwa, kuona jinsi mbinu hizo zinavyofaa na uwafanya
                            washiriki zaidi.
                        </div>
                    </div>
                </div>
